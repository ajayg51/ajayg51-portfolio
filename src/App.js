    ...
    <div>
      ...
      <div className='App'>
        ...
        <footer className='FOOTER'>
            ...
            <p><a href='https://drive.google.com/file/d/15l151r37SFJqQohU75SGzFNWZxpzp8nC/view?usp=sharing'><span className='CLICK-PDF'>Click here</span></a> to get pdf version of my resume.</p>
        </footer>
      </div>
    </div>
    );  
